...
import { cancelAll, dataURIToBlob, download, RequestPromise } from "./utils";
...
export declare const request: {
  <T = any, Config extends AxiosRequestConfig<any> = {}>(
    configOrUrl: string | Config,
    setLoading?: boolean,
  ): RequestPromise<RequestResponseType<Config, T>>;
  get: <T_1 = any, Config_1 extends AxiosRequestConfig<any> = {}>(
    url: string,
    config?: Config_1 | undefined,
    setLoading?: boolean,
  ) => RequestPromise<
    RequestResponseType<
      {
    ...
    >
  >;
  post: <T_2 = any, Config_2 extends AxiosRequestConfig<any> = {}>(
    url: string,
    config?: Config_2 | undefined,
    setLoading?: boolean,
  ) => RequestPromise<
    RequestResponseType<
      {
    ...
    >
  >;
  delete: <T_3 = any, Config_3 extends AxiosRequestConfig<any> = {}>(
    url: string,
    config?: Config_3 | undefined,
    setLoading?: boolean,
  ) => RequestPromise<
    RequestResponseType<
      {
    ...
    >
  >;
  patch: <T_4 = any, Config_4 extends AxiosRequestConfig<any> = {}>(
    url: string,
    config?: Config_4 | undefined,
    setLoading?: boolean,
  ) => RequestPromise<
    RequestResponseType<
      {
    ...
    >
  >;
  put: <T_5 = any, Config_5 extends AxiosRequestConfig<any> = {}>(
    url: string,
    config?: Config_5 | undefined,
    setLoading?: boolean,
  ) => RequestPromise<
    RequestResponseType<
      {
    ...
    >
  >;
  options: <T_6 = any, Config_6 extends AxiosRequestConfig<any> = {}>(
    url: string,
    config?: Config_6 | undefined,
    setLoading?: boolean,
  ) => RequestPromise<
    RequestResponseType<
      {
  ...
  install(
    app: App<Element>,
    optionsOverride?: Partial<Options> | undefined,
  ): void;
};
 ...
 * ```
 */
export declare const requestAll: <T extends [] | readonly unknown[]>(
  requests: T,
  setLoading?: boolean,
