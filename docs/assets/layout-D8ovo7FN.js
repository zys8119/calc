    ...
    setup(e) {
      ...
      Ze(A, (i, u) => {
        ...
        if (
          (L !== null && (he = u),
          Q !== null &&
            (he === void 0 ? (he = i) : (he = he.filter((Z) => Z !== Q))),
          (Ee.value = !0),
          (ke.value = N.value.getFlattenedNodes(he)),
          L !== null)
        ) {
          const Z = ke.value.findIndex((ve) => ve.key === L);
          if (~Z) {
            const ve = ke.value[Z].children;
            if (ve) {
              const be = Ct(ve, i);
        ...
        if (Q !== null) {
          const Z = ke.value.findIndex((ve) => ve.key === Q);
          if (~Z) {
            const ve = ke.value[Z].children;
            if (!ve) return;
            Ee.value = !0;
