System.register(["./index-legacy-CzynbWA3.js"], function (e, t) {
  "use strict";
  var l, n, i, s, r, c, o, a, f, u, d, v, h, x, g;
  return {
    setters: [
      (e) => {
        (l = e.s),
    ...
    execute: function () {
      const t = l(
          ...
          l("circle", { fill: "#FFCB4C", cx: "18", cy: "17.018", r: "17" }),
          l("path", {
            fill: "#65471B",
        ...
        w = n(
          ...
          [
            ...
            n("result-content", { marginTop: "24px" }),
            n("result-footer", "\n margin-top: 24px;\n text-align: center;\n "),
            n("result-header", [
              i(
                "title",
        ...
        y = Object.assign(Object.assign({}, c.props), {
      ...
      e(
        ...
        s({
          ...
          props: y,
          setup(e) {
            const { mergedClsPrefixRef: t, inlineThemeDisabled: l } = r(e),
              n = c("Result", "-result", w, x, e, t),
              i = o(() => {
                const { size: t, status: l } = e,
                  {
          ...
          render() {
            ...
            return (
              ...
              l(
                "div",
                {
                  class: [`${i}-result`, this.themeClass],
                  style: this.cssVars,
                },
                l(
                  "div",
                  ...
                  (null === (e = n.icon) || void 0 === e
                    ? void 0
                    : e.call(n)) ||
                    l(f, { clsPrefix: i }, { default: () => C[t]() }),
                ),
                l(
                  "div",
                  { class: `${i}-result-header` },
                  this.title
                    ? l(
                        "div",
                        { class: `${i}-result-header__title` },
                        this.title,
                      )
                    : null,
                  this.description
                    ? l(
                        "div",
                        { class: `${i}-result-header__description` },
                        this.description,
                      )
                    : null,
                ),
                n.default && l("div", { class: `${i}-result-content` }, n),
                n.footer &&
                  l("div", { class: `${i}-result-footer` }, n.footer()),
              )
            );
          },
        }),
