System.register(["./index-legacy-CzynbWA3.js"], function (n, A) {
  "use strict";
  var i, h, g, C, E, D, B, F, u, y, z, l, j, o;
  return {
    setters: [
      (n) => {
        (i = n.aJ),
    ...
    execute: function () {
      ...
      function c(n, i) {
        var h,
          g = [];
        return (
          (n = n.replace(/[\u4E00-\uFA29]|[\uE7C7-\uE7F3]|\w+/gi, function (n) {
            return (h = A[x(n)]) && g.push(h), h;
          })),
          g
        );
      }
      function x(n) {
        return (escape(n).match(/^%u(\w+)$/) || [])[1];
      }
      (c.STYLE_INITIAL = 0),
        (c.STYLE_TONE = 1),
        (c.unicode = x),
        (c.normalize = function (n) {
          var A = { a: "āáǎà", e: "ēéěè", i: "īíǐì", o: "ōóǒò", u: "ūúǔù" };
          return (
            Object.keys(A).forEach(function (i) {
              n = n.replace(new RegExp("[" + A[i] + "]"), i);
            }),
            n
          );
        });
      const s = i(c),
        q = { class: "pingyin" },
        d = { class: "flex-center flex-col" },
        t = { class: "m-y-15px" },
        b = { class: "flex-center" },
        m = { class: "p-15px" },
        p = { class: "m-b-15px flex items-end gap-5px" },
        w = ["onClick"],
        f = { class: "flex flex-col gap-5px flex-wrap text-50px" },
        k = ["onClick"],
        r = { key: 0, class: "text-18px flex-center-start gap-10px" },
        e = ["src"],
        a = h({
          __name: "pinyin",
          setup(n) {
            const A = z(),
              i = g(Number(A.query.active) || 7),
              h = C(() => {
                const n = {
                  7: {
                    title: "拼音练习7（声母）",
              ...
              c = Object.keys(o),
              x = new RegExp(c.join("|")),
              a = Object.entries(o).reduce(
                (n, [A, i]) => (
                  i.forEach((i, h) => {
                    n[i] = { name: A, index: h + 1 };
                  }),
                  n
                ),
                {},
                  ...
                  n.map((n) =>
                    ((n) =>
                      n
                        ...
                        .filter((n) => n)
                        .map((n) => {
                          if (_.test(n)) return n;
                          const A = Number(n.match(/[0-9]$/i) || 1);
                          let i = n.replace(A, ""),
                            h = i.length;
                          for (; h--; )
                            if (x.test(i[h])) {
              ...
              S = async (n, A = !1) => {
                if (((R.value = A), n)) {
                  ...
                  const { index: A, name: i } = ((n) => {
                    ...
                    h = n.replace(new RegExp(_, "img"), i) + (A || ""),
                    g = `https://data.hanyuguoxue.com/voice/${h}.mp3`,
                    C = await fetch(g).then((n) => n.status);
                  (I.value =
                    200 === C
                      ? g
                      : `https://data.hanyuguoxue.com/pinyin_voice/${h}.mp3`),
                    N.value.play();
                }
              },
              T = C(() =>
                h.value.data.map((n) => {
                  return {
                    ...
                    title:
                      ...
                      A.split("").map((n) => ({
                        text: n,
                        pinyin: /^[\u2E80-\u9FFF]+$/.test(n) ? i.pop() : null,
                      }))),
                    pinyin: O(
                      n.pinyin.map((n) =>
                        "string" == typeof n ? n.split(" ") : n,
                      ),
                    ),
                  };
                  var A, i;
            ...
            return (n, A) => (
              ...
              E("div", q, [
                                  ...
                                  (n, A) => (
                                    ...
                                    E(
                                      "span",
                                      {
                                        ...
                                        key: A,
                                        onClick: (A) => S(n.pinyin),
                                      },
                                      [
                                        D("span", null, B(n.pinyin), 1),
                                        D("span", null, B(n.text), 1),
                                      ],
                                      8,
                                      w,
                                    )
                                ...
                                y(
                                  ...
                                  (n, A) => (
                                    ...
                                    E(
                                      ...
                                      {
                                        class:
                                          "flex-center-start gap-30px flex-wrap",
                                        key: A,
                                      },
                                      [
                                        (l(!0),
                ...
                D(
                  "audio",
                  { src: F(I), ref_key: "audio", ref: N, autoplay: "" },
                  null,
                  8,
                  e,
                ),
      ...
      n("default", o(a, [["__scopeId", "data-v-d563cea5"]]));
    },
  };
});
