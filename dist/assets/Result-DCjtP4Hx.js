...
const I = e(
    ...
    e("circle", { fill: "#FFCB4C", cx: "18", cy: "17.018", r: "17" }),
    e("path", {
      fill: "#65471B",
  ...
  L = e(
    ...
    e("ellipse", { fill: "#664500", cx: "18", cy: "27", rx: "5", ry: "6" }),
    e("path", {
      fill: "#664500",
  ...
  $ = e(
    "svg",
    { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 36 36" },
    e("ellipse", { fill: "#292F33", cx: "18", cy: "26", rx: "18", ry: "10" }),
    e("ellipse", { fill: "#66757F", cx: "18", cy: "24", rx: "18", ry: "10" }),
    e("path", {
      fill: "#E1E8ED",
    ...
    e("ellipse", { fill: "#A6D388", cx: "18", cy: "13", rx: "15", ry: "7" }),
    e("path", {
  ...
  P = c(
    ...
    [
      ...
      c("result-content", { marginTop: "24px" }),
      c("result-footer", "\n margin-top: 24px;\n text-align: center;\n "),
      c("result-header", [
        u(
          "title",
  ...
  j = Object.assign(Object.assign({}, g.props), {
  ...
  O = B({
    ...
    props: j,
    setup(s) {
      const { mergedClsPrefixRef: a, inlineThemeDisabled: i } = F(s),
        t = g("Result", "-result", P, E, s, a),
        l = h(() => {
          const { size: o, status: f } = s,
            {
    ...
    render() {
      var s;
      const { status: a, $slots: i, mergedClsPrefix: t, onRender: l } = this;
      return (
        l == null || l(),
        e(
          "div",
          {
            class: ["".concat(t, "-result"), this.themeClass],
            style: this.cssVars,
          },
          e(
            "div",
            { class: "".concat(t, "-result-icon") },
            ((s = i.icon) === null || s === void 0 ? void 0 : s.call(i)) ||
              e(M, { clsPrefix: t }, { default: () => T[a]() }),
          ),
          e(
            "div",
            { class: "".concat(t, "-result-header") },
            this.title
              ? e(
                  "div",
                  { class: "".concat(t, "-result-header__title") },
                  this.title,
                )
              : null,
            this.description
              ? e(
                  "div",
                  { class: "".concat(t, "-result-header__description") },
                  this.description,
                )
              : null,
          ),
          i.default && e("div", { class: "".concat(t, "-result-content") }, i),
          i.footer &&
            e("div", { class: "".concat(t, "-result-footer") }, i.footer()),
        )
      );
    },
  });
